export class BaseClass {
     ...
     */
    addClass(element: HTMLElement|Array<HTMLElement>, name: string) {
     ...
     */
    setStyle(element, property, value, priority = null, resetValue: any = null, resetTimeout: number = 5000) {
     ...
     * @param resetTimeout timeout in milliseconds to reset style to (optional)
     */
    setContent(element, value, tooltip: any = null, resetValue: any = null, resetTimeout: number = 5000) {
     ...
     * @returns element 
     */
    createElement(tagName, properties: any = null, ...children) {
        try {
